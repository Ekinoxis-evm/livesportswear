...
export default async function StorePerformancePage({
  ...
  const [
    ...
    service
      .from("client_events")
      .select(
        "id, employee_id, attended_at, kind, return_type, sold, got_contact, served_seconds, order_total, shopify_order_name, linked_orders, customer_name, bought_before, knew_brand, reasons, note",
      )
