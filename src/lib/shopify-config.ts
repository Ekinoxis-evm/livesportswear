...
// Dashboard app (scopes: read_orders, read_users; read_all_orders for history
// beyond 60 days). SHOPIFY_ADMIN_TOKEN is a legacy override for a permanent
// custom-app token — used directly when set.
