...
- `supabase/migrations/` — append-only, currently through `0048`. **Apply with `.claude/scripts/db-apply.sh <name>`** — never a hand-written curl (see `.claude/commands/db-migrate.md`).
